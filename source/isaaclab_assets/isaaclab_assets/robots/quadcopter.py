...
# UAV_LIDAR
UAVLIDAR_CFG = ArticulationCfg(
    prim_path="{ENV_REGEX_NS}/Robot",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/zzyu/IsaacNew/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/direct/quadcopter/asserts/uav_lidar/uav_lidar.usd",
